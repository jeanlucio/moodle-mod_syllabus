...
$string['finalassessmenthelp'] = 'Marque a atividade que representa a Avaliação Final da disciplina, se houver.';
$string['finalassessmenthelpfull'] = 'Marque esta caixa para a atividade que representa a Avaliação Final da disciplina — ela é destinada aos estudantes que não atingiram média da disciplina (MD) igual ou superior a 70, desde que tenham obtido MD maior ou igual a 40, e deve abranger os conteúdos ministrados em todo o componente curricular. Nota sobre pontuação: o modelo original prevê que cada atividade valha 100 pontos; neste plugin, a pontuação de todas as atividades da disciplina (ou de cada etapa, se houver mais de uma) soma 100 — ajuste os pontos desta atividade considerando essa distribuição.';
...
$string['viewmodelguidance'] = 'Ver orientações do modelo';
