...
/**
 * Tests for the plan_submitted event.
 *
...
/**
 * Tests for the plan_submitted event class itself.
 *
 ...
 *
 * @coversDefaultClass \mod_syllabus\event\plan_submitted
 */
final class plan_submitted_test extends advanced_testcase {
    #[\Override]
    ...
    /**
     * Builds a real plan_submitted event against a real course module context.
     *
     * @return plan_submitted
     */
    private function build_event(): plan_submitted {
    ...
    public function test_name_description_url_and_mapping(): void {
        ...
        $this->assertSame(get_string('eventplansubmitted', 'mod_syllabus'), plan_submitted::get_name());
        $this->assertStringContainsString((string) $event->objectid, $event->get_description());
        $this->assertStringContainsString('submitted', $event->get_description());
        $this->assertStringContainsString('/mod/syllabus/view.php', $event->get_url()->out(false));
        $this->assertSame(['db' => 'syllabus', 'restore' => 'syllabus'], plan_submitted::get_objectid_mapping());
    }
