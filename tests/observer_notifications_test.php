 ...
 *
 * @coversDefaultClass \mod_syllabus\observer
 */
final class observer_notifications_test extends advanced_testcase {
     ...
     * submitter themself, even when the submitter also happens to hold that capability.
     *
     * @covers ::plan_submitted
     * @return void
     */
