...
$string['activityperiod'] = 'Activity start/end date';
...
$string['changedsincereview'] = 'Changed since last review';
...
$string['confirmresetfielddescription'] = 'Restore this field\'s description to the plugin\'s default text? Any customisation already made will be lost.';
...
$string['coordinatornotebadge'] = 'Adjustment requested by the coordinator';
...
$string['fielddescriptionreset'] = 'Field description restored to the default text.';
$string['finalassessment'] = 'Final assessment';
$string['finalassessmentenddate'] = 'End date';
$string['finalassessmenthelp'] = 'Plan the discipline\'s Final assessment, a recovery activity outside the regular stage(s).';
$string['finalassessmenthelpfull'] = 'Fill in this block for the discipline\'s Final assessment — it is meant for students who did not reach a discipline average (MD) of 70 or higher, provided they reached at least 40, and should cover the content taught across the whole discipline. It has its own 100-point total, separate from the regular stage(s): it is never added to a stage\'s own 100-point sum, and does not factor into the grading method chosen for the regular stages.';
$string['finalassessmentinstructionshelp'] = 'Explain to the student what the Final assessment consists of and how to complete it.';
$string['finalassessmentinstructionshelpfull'] = 'Write a detailed, clear and objective prompt, speaking directly to the student, the same way you would for a regular activity\'s instructions: the assessment\'s purpose, what to do, and which of the discipline\'s content it draws on.';
$string['finalassessmentpoints'] = 'Points';
$string['finalassessmentstartdate'] = 'Start date';
$string['finalassessmenttitle'] = 'Title';
$string['finalassessmenttype'] = 'Type';
...
$string['grademethodaverage'] = 'Average of grades per stage';
$string['grademethodhelp'] = 'How the stage grades are meant to be combined into a final result — informational only, shown in the read-only views; this plan never computes an actual grade.';
$string['grademethodsum'] = 'Sum of points per stage';
...
$string['messagebodysubmitted'] = 'The syllabus plan "{$a->planname}" ({$a->coursename}) was submitted for review.';
$string['messagedetailauthor'] = 'Teacher: {$a}';
$string['messagedetailcoursestart'] = 'Course\'s expected start date: {$a}';
$string['messagedetaillink'] = 'View the plan: {$a}';
$string['messagedetailresubmission'] = 'This is a resubmission, after changes were requested.';
$string['messagedetailresubmissionnote'] = 'Teacher\'s note: {$a}';
$string['messagedetailsubmitted'] = 'Submission date and time: {$a}';
...
$string['messagestartdatenotset'] = 'not set';
...
$string['missingrequiredfields'] = 'This plan cannot be submitted: the following required fields are still empty: {$a}.';
...
$string['newsincereview'] = 'New since last review';
...
$string['privacy:metadata:syllabus_review_notes'] = 'Records coordinator observations left on specific narrative fields of a syllabus plan.';
$string['privacy:metadata:syllabus_review_notes:note'] = 'The text of the coordinator\'s note.';
$string['privacy:metadata:syllabus_review_notes:reviewerid'] = 'The ID of the coordinator who wrote the note.';
$string['privacy:metadata:syllabus_review_notes:timecreated'] = 'The time the note was created.';
$string['reasonforchanges'] = 'Reason for the requested changes';
$string['removedsincereview'] = 'Removed since last review';
$string['requestchanges'] = 'Request changes';
$string['requiredfielddesc'] = 'Blocks submitting the plan for review while this field is left empty.';
$string['requiredfieldssettings'] = 'Required fields on submission';
$string['requiredfieldssettingsinfo'] = 'Choose which of these structural fields block submitting the plan for review when left empty. The narrative text fields under Plan content, Week content and Activity each have their own "Is this field required?" toggle on their area\'s Manage fields screen.';
$string['resetfielddescription'] = 'Restore default text';
$string['resubmissionnote'] = 'Note to the coordinator';
$string['resubmissionnoteplaceholder'] = 'Explain what changed, if you\'d like...';
$string['reviewnote'] = 'Coordinator note';
$string['reviewnotehelp'] = 'Leave a note on a specific field to guide the teacher on what needs adjusting.';
$string['reviewnoteplaceholder'] = 'Write a note for the teacher about this field...';
$string['reviewnotesaved'] = 'Note saved';
$string['reviewnotesheading'] = 'Coordinator observations';
$string['saved'] = 'Saved';
...
$string['stage'] = 'Stage';
$string['stagecount'] = 'Number of stages';
$string['stagecounthelp'] = 'How many independent 100-point grading stages this plan is divided into. Leave at 1 for a single continuous-assessment stage — no stage selection is shown anywhere in that case.';
$string['stagen'] = 'Stage {$a}';
$string['stageoutofrange'] = '(out of range for the current stage count)';
