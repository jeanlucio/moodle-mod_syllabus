...
$string['activityperiod'] = 'Data de início/fim da atividade';
...
$string['changedsincereview'] = 'Alterado desde a última revisão';
...
$string['coordinatornotebadge'] = 'Ajuste solicitado pela coordenação';
...
$string['messagebodysubmitted'] = 'O plano de disciplina "{$a->planname}" ({$a->coursename}) foi submetido para revisão.';
$string['messagedetailauthor'] = 'Professor(a): {$a}';
$string['messagedetailcoursestart'] = 'Data prevista de início do curso: {$a}';
$string['messagedetaillink'] = 'Acesse o plano: {$a}';
$string['messagedetailresubmission'] = 'Este é um reenvio, após solicitação de alterações.';
$string['messagedetailresubmissionnote'] = 'Observação do(a) professor(a): {$a}';
$string['messagedetailsubmitted'] = 'Data e hora da submissão: {$a}';
...
$string['messagestartdatenotset'] = 'não definida';
...
$string['missingrequiredfields'] = 'Não é possível enviar este plano: os seguintes campos obrigatórios ainda estão vazios: {$a}.';
...
$string['newsincereview'] = 'Nova desde a última revisão';
...
$string['privacy:metadata:syllabus_review_notes'] = 'Registra observações da coordenação deixadas em campos narrativos específicos de um plano de disciplina.';
$string['privacy:metadata:syllabus_review_notes:note'] = 'O texto da observação da coordenação.';
$string['privacy:metadata:syllabus_review_notes:reviewerid'] = 'O ID da coordenação que escreveu a observação.';
$string['privacy:metadata:syllabus_review_notes:timecreated'] = 'A data em que a observação foi criada.';
$string['reasonforchanges'] = 'Motivo do ajuste solicitado';
$string['removedsincereview'] = 'Removido desde a última revisão';
$string['requestchanges'] = 'Solicitar ajustes';
$string['requiredfielddesc'] = 'Bloqueia o envio do plano para revisão enquanto este campo estiver vazio.';
$string['requiredfieldssettings'] = 'Campos obrigatórios ao enviar';
$string['requiredfieldssettingsinfo'] = 'Escolha quais destes campos estruturais bloqueiam o envio do plano para revisão quando estiverem vazios. Os campos de texto do Conteúdo do Plano, da Aula e da Atividade têm seu próprio interruptor "Este campo é obrigatório?" na tela de Gerenciar campos de cada área.';
$string['resetfielddescription'] = 'Restaurar texto padrão';
$string['resubmissionnote'] = 'Observação para a coordenação';
$string['resubmissionnoteplaceholder'] = 'Explique o que mudou, se quiser...';
$string['reviewnote'] = 'Observação da coordenação';
$string['reviewnotehelp'] = 'Deixe uma observação num campo específico para orientar o professor sobre o que precisa de ajuste.';
$string['reviewnoteplaceholder'] = 'Escreva uma observação para o professor sobre este campo...';
$string['reviewnotesaved'] = 'Observação salva';
$string['reviewnotesheading'] = 'Observações da coordenação';
$string['saved'] = 'Salvo';
